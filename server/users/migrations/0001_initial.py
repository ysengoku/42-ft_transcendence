    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()])),
                ('slug_id', models.SlugField(default='', max_length=32, unique=True)),
                ('email', models.EmailField(default='', max_length=254, unique=True)),
                ('connection_type', models.CharField(choices=[('42', '42 School API'), ('github', 'Github API'), ('regular', 'Our Own Auth')], default='regular', max_length=15)),
