    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connection_type', models.CharField(choices=[('42', '42 School API'), ('github', 'Github API'), ('regular', 'Our Own Auth')], default='regular', max_length=10)),
                ('oauth_id', models.IntegerField(blank=True, null=True)),
                ('password', models.CharField(default='', max_length=128)),
                ('mfa_secret', models.CharField(default='', max_length=128)),
