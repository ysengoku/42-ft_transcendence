...
from pong.consumers.game_protocol import GameRoomToClientEvents, GameRoomToGameWorkerEvents, SerializedGameState
...
class GameConsumer(AsyncConsumer):
    ...
    async def player_connected(self, event: PlayerConnectedEvent):
    ...
    def _add_player_and_create_pending_match(self, event: PlayerConnectedEvent):
        player_id = event["player_id"]
        game_room_id = event["game_room_id"]
    ...
    async def _add_player_and_start_match(self, match: MultiplayerPongMatch, event: PlayerConnectedEvent):
